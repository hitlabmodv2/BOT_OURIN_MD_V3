...
[x] 5. Verify the project works end-to-end: fixed tebakhewan image loading — now falls back to text+deskripsi mode when gambar gagal dimuat (Wikipedia blocks Replit IPs), with proper browser headers on fetch attempt.
