 ...
 * kuaishou(url).then(data => console.log(data)).catch(err => console.error(err)); // JSON
 */
declare function kuaishou(url: string): Promise<KuaishouResponse>;
export { fbdown, igdl, ttdl, twitter, youtube, mediafire, capcut, gdrive, pinterest, aio, xiaohongshu, douyin, snackvideo, cocofun, spotify, yts, soundcloud, threads, kuaishou, version as VERSION, wm as developer, issues };
